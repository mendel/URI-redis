...
# ABSTRACT: URI for Redis connection info
...
=method password_from_userinfo

Returns the password part of the L<URI/userinfo>.

=method password_from_query
...
=for Pod::Coverage host default_port
